...
public class WeaponManager : MonoBehaviour
{
    ...
    private void Start()
    {
        activeWeaponSlot = weaponSlots[0]; // Set the first weapon slot as active by default
    }
    ...
    private void DropCurrentWeapon(GameObject pickedWeapon)
    {
        if (activeWeaponSlot.transform.childCount > 0)
        {
            ...
            weaponToDrop.transform.localPosition = pickedWeapon.transform.transform.localPosition;
            weaponToDrop.transform.localRotation = pickedWeapon.transform.transform.localRotation;
        }
    }
